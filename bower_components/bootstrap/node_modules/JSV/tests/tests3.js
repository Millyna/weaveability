...
for (curDraftId = 0; curDraftId < DRAFTS.length; ++curDraftId) {
    ...
    test("AdditionalProperties Validation", function () {
        ...
        equal(env.validate({a: 1, b: 2, c: 3}, {
            properties: {a: {}, b: {}},
        ...
        notEqual(env.validate({a: 1, b: 2, c: 3}, {
            properties: {a: {}, b: {}},
            additionalProperties: false
        }).errors.length, 0);
        notEqual(env.validate({a: 1, b: 2, c: 3}, {
        ...
        equal(env.validate(['1', '2'], {
            items: [{type: 'string'}, {type: 'string'}],
            additionalProperties: false
        }).errors.length, 0);
        equal(env.validate(['1', '2', 3], {
            items: [{type: 'string'}, {type: 'string'}],
            additionalProperties: {type: 'number'}
        }).errors.length, 0);
        equal(env.validate(['1', '2', '3'], {
    ...
    test("Requires Validation", function () {
        ...
        equal(env.validate({
            a: 1,
            b: 2
        }, {properties: {b: {requires: {properties: {a: {type: 'number'}}}}}}).errors.length, 0);
    ...
    test("MinimumCanEqual/MaximumCanEqual Validation", function () {
        ...
        equal(env.validate(1, {
            minimum: 1,
            maximum: 10,
            minimumCanEqual: true,
            maximumCanEqual: true
        }).errors.length, 0);
        equal(env.validate(5, {
            minimum: 1,
            maximum: 10,
            minimumCanEqual: true,
            maximumCanEqual: true
        }).errors.length, 0);
        equal(env.validate(10, {
            minimum: 1,
            maximum: 10,
            minimumCanEqual: true,
            maximumCanEqual: true
        ...
        notEqual(env.validate(0, {
            minimum: 1,
            maximum: 10,
            minimumCanEqual: true,
            maximumCanEqual: true
        }).errors.length, 0);
        notEqual(env.validate(11, {
            minimum: 1,
            maximum: 10,
            minimumCanEqual: true,
            maximumCanEqual: true
        ...
        notEqual(env.validate(1, {
            minimum: 1,
            maximum: 10,
            minimumCanEqual: false,
            maximumCanEqual: false
        }).errors.length, 0);
        notEqual(env.validate(10, {
            minimum: 1,
            maximum: 10,
            minimumCanEqual: false,
            maximumCanEqual: false
    ...
    test("Extends Validation", function () {
        ...
        equal(env.validate({a: 1, b: 2}, {
            ...
            additionalProperties: false,
            'extends': {properties: {b: {type: 'number'}}}
        }).errors.length, 0);
