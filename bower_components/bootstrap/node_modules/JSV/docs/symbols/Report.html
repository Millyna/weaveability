...
<div id="content">
    ...
    <table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class Report.">
        ...
        <tr>
            ...
            <td class="nameDescription">
                ...
                <div class="description">Reports are returned from validation methods to describe the result of a
                    validation.
                </div>
            </td>
        </tr>
    ...
    <table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class Report.">
        ...
        <tr>
            ...
            <td class="nameDescription">
                ...
                <div class="description">An array of <a href="../symbols/ValidationError.html">ValidationError</a>
                    objects that define all the errors generated by the schema against the instance.
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="nameDescription">
                ...
                <div class="description">If the report is generated by <a href="../symbols/Environment.html#validate">Environment#validate</a>,
                    this field is the generated instance.
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="nameDescription">
                ...
                <div class="description">If the report is generated by <a href="../symbols/Environment.html#validate">Environment#validate</a>,
                    this field is the generated schema.
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="nameDescription">
                ...
                <div class="description">If the report is generated by <a href="../symbols/Environment.html#validate">Environment#validate</a>,
                    this field is the schema's schema.
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="nameDescription">
                ...
                <div class="description">A hash table of every instance and what schemas were validated against it.
                </div>
            </td>
        </tr>
    ...
    <table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class Report.">
        ...
        <tr>
            <td class="attributes">&nbsp;</td>
            <td class="nameDescription">
                <div class="fixedFont"><b><a href="../symbols/Report.html#addError">addError</a></b>(instance, schema,
                    attr, message, details)
                </div>
                <div class="description">Adds a <a href="../symbols/ValidationError.html">ValidationError</a> object to
                    the <a href="#errors"><code>errors</code></a> field.
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td class="attributes">&nbsp;</td>
            <td class="nameDescription">
                <div class="fixedFont"><b><a href="../symbols/Report.html#isValidatedBy">isValidatedBy</a></b>(uri,
                    schemaUri)
                </div>
                <div class="description">Returns if an instance with the provided URI has been validated by the schema
        ...
        <tr>
            <td class="attributes">&nbsp;</td>
            <td class="nameDescription">
                <div class="fixedFont"><b><a href="../symbols/Report.html#registerValidation">registerValidation</a></b>(uri,
                    schemaUri)
                </div>
                <div class="description">Registers that the provided instance URI has been validated by the provided
                    schema URI.
                </div>
            </td>
        </tr>
    ...
    <div class="description">
        An array of <a href="../symbols/ValidationError.html">ValidationError</a> objects that define all the errors
        generated by the schema against the instance.
    ...
    <div class="description">
        If the report is generated by <a href="../symbols/Environment.html#validate">Environment#validate</a>, this
        field is the generated instance.
    ...
    <div class="description">
        Adds a <a href="../symbols/ValidationError.html">ValidationError</a> object to the <a href="#errors"><code>errors</code></a>
        field.
    ...
    <dl class="detailList">
        ...
        <dt>
            <span class="light fixedFont">{<a href="../symbols/JSONSchema.html">JSONSchema</a>|String}</span>
            <b>schema</b>
...
<div class="fineprint" style="clear:both">
    ...
    on Wed Sep 14 2011 18:53:24 GMT-0600 (MDT)
</div>
</body>
</html>
