...
(this.define || function (N, O) {
    ...
    (function n(v, m, c) {
        ...
        for (var k = "function" == typeof require && require, q = 0; q < c.length; q++)d(c[q]);
        return d
    })({
        1: [function (n,
                      v, m) {
        ...
        2: [function (n, v, m) {
            (function (c) {
                function d(c) {
                    c = c.charCodeAt(0);
                    if (43 === c || 45 === c)return 62;
                    if (47 === c || 95 === c)return 63;
                    if (48 > c)return -1;
                    if (58 > c)return c - 48 + 52;
                    if (91 > c)return c - 65;
                    if (123 > c)return c - 97 + 26
                }
                ...
                c.toByteArray = function (c) {
                    ...
                    if (0 < c.length % 4)throw Error("Invalid string. Length must be a multiple of 4");
                    var a = c.length;
                    var h = "=" === c.charAt(a - 2) ? 2 : "=" === c.charAt(a -
                        1) ? 1 : 0;
                ...
                c.fromByteArray = function (c) {
                    var e = c.length % 3, a = "", h;
                    var d = 0;
                    for (h = c.length - e; d < h; d += 3) {
                        var r = (c[d] << 16) + (c[d + 1] << 8) + c[d + 2];
                        r =
                            "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(r >> 18 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(r >> 12 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(r >> 6 & 63) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(r & 63);
                        a += r
                    }
                    switch (e) {
                        case 1:
                            ...
                            a += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(r <<
                                4 & 63);
                            a += "==";
                            break;
                        case 2:
        ...
        4: [function (n, v, m) {
            function c(g, l, b) {
                if (!(this instanceof c))return new c(g, l, b);
                var x = typeof g;
                if ("base64" === l && "string" === x)for (g = g.trim ? g.trim() : g.replace(/^\s+|\s+$/g, ""); 0 !== g.length % 4;)g += "=";
                if ("number" === x)var a = B(g); else if ("string" === x)a = c.byteLength(g, l); else if ("object" === x)a = B(g.length); else throw Error("First argument needs to be a number, array or string.");
                if (c._useTypedArrays)var f = c._augment(new Uint8Array(a)); else f = this, f.length = a, f._isBuffer = !0;
                if (c._useTypedArrays && "number" === typeof g.byteLength)f._set(g); else {
                    var e = g;
                    if (L(e) || c.isBuffer(e) || e && "object" === typeof e && "number" === typeof e.length)for (l = 0; l < a; l++)c.isBuffer(g) ? f[l] = g.readUInt8(l) : f[l] = g[l]; else if ("string" === x)f.write(g, 0, l); else if ("number" === x && !c._useTypedArrays && !b)for (l = 0; l < a; l++)f[l] = 0
                }
                return f
            }
            ...
            function d(g, l, b) {
                var x = "";
                for (b = Math.min(g.length, b); l < b; l++)x += String.fromCharCode(g[l]);
                return x
            }
            ...
            function e(g, l, b, a) {
                a || (p("boolean" === typeof b, "missing or invalid endian"),
                    p(void 0 !== l && null !== l, "missing offset"), p(l + 1 < g.length, "Trying to read beyond buffer length"));
                if (!(l >= g.length))return g = k(g, l, b, !0), g & 32768 ? -1 * (65535 - g + 1) : g
            }

            function a(g, l, b, a) {
                a || (p("boolean" === typeof b, "missing or invalid endian"), p(void 0 !== l && null !== l, "missing offset"), p(l + 3 < g.length, "Trying to read beyond buffer length"));
                if (!(l >= g.length))return g = q(g, l, b, !0), g & 2147483648 ? -1 * (4294967295 - g + 1) : g
            }
            ...
            function r(g, l, b, a, c) {
                ...
                var x = g.length;
                if (!(b >= x))for (c = 0, x = Math.min(x - b, 2); c < x; c++)g[b + c] = (l & 255 << 8 * (a ? c : 1 - c)) >>> 8 *
                    (a ? c : 1 - c)
            }
            ...
            function b(g, l, b, a, c) {
                ...
                var x = g.length;
                if (!(b >= x))for (c = 0, x = Math.min(x - b, 4); c < x; c++)g[b + c] = l >>> 8 * (a ? c : 3 - c) & 255
            }

            function f(g, l, b, a, c) {
                c || (p(void 0 !== l && null !== l, "missing value"), p("boolean" === typeof a, "missing or invalid endian"), p(void 0 !== b && null !== b, "missing offset"), p(b + 1 < g.length,
                    "Trying to write beyond buffer length"), z(l, 32767, -32768));
            ...
            function t(g, b, a, c, f) {
                f || (p(void 0 !== b && null !== b, "missing value"), p("boolean" === typeof c,
                    "missing or invalid endian"), p(void 0 !== a && null !== a, "missing offset"), p(a + 3 < g.length, "Trying to write beyond buffer length"), E(b, 3.4028234663852886E38, -3.4028234663852886E38));
            ...
            function M(g, b, a, c, f) {
                ...
                a >= g.length || J.write(g,
                    b, a, c, 52, 8)
            }

            function I(g, b, a) {
                if ("number" !== typeof g)return a;
                g = ~~g;
                if (g >= b)return b;
                if (0 <= g)return g;
                g += b;
            ...
            function y(g) {
                for (var b = [], a = 0; a < g.length; a++) {
                    ...
                    if (127 >= c)b.push(g.charCodeAt(a)); else {
                        var f = a;
                        55296 <= c && 57343 >= c && a++;
                        c = encodeURIComponent(g.slice(f,
                            a + 1)).substr(1).split("%");
                        for (f = 0; f < c.length; f++)b.push(parseInt(c[f], 16))
                    }
                }
                return b
            }
            ...
            function K(g) {
                for (var b = [], a = 0; a < g.length; a++)b.push(g.charCodeAt(a) & 255);
                return b
            }

            function A(g, b, a, c) {
                for (var l = 0; l < c && !(l + a >= b.length || l >= g.length); l++)b[l + a] = g[l];
                return l
            }
            ...
            function H(g, b) {
                ...
                p(g <=
                    b, "value is larger than maximum value for type");
            ...
            c._useTypedArrays = function () {
                try {
                    var g = new ArrayBuffer(0), b = new Uint8Array(g);
                    b.foo = function () {
                        return 42
                    };
            ...
            c.concat = function (g, b) {
                ...
                if (0 === g.length)return new c(0);
                if (1 === g.length)return g[0];
                var a;
                if ("number" !== typeof b)for (a = b = 0; a < g.length; a++)b += g[a].length;
                var l = new c(b), f = 0;
            ...
            c.prototype.write = function (g, b, a, f) {
                ...
                switch (f) {
                    case "hex":
                        ...
                        a > f / 2 && (a = f / 2);
                        for (f = 0; f < a; f++)l = parseInt(g.substr(2 * f, 2), 16), p(!isNaN(l), "Invalid hex string"), this[b + f] = l;
                        c._charsWritten = 2 * f;
                        g = f;
                        break;
                    case "utf8":
                    ...
                    case "utf16le":
                    case "utf-16le":
                        for (var e, l = [], h = 0; h < g.length; h++)e =
                            g.charCodeAt(h), f = e >> 8, e %= 256, l.push(e), l.push(f);
            ...
            c.prototype.toString = function (g, b, a) {
                ...
                switch (g) {
                    case "hex":
                        ...
                        if (!b || 0 > b)b = 0;
                        if (!a || 0 > a || a > g)a = g;
                        for (g = ""; b < a; b++)g += C(this[b]);
                        a = g;
                        break;
                    case "utf8":
                    case "utf-8":
                        var c = g = "";
                        for (a = Math.min(this.length, a); b < a; b++)127 >= this[b] ? (g += F(c) + String.fromCharCode(this[b]),
            ...
            c.prototype.copy = function (g, b, a, f) {
                ...
                f || 0 === f || (f = this.length);
                b || (b = 0);
                if (f !== a && 0 !== g.length && 0 !== this.length)if (p(f >= a, "sourceEnd < sourceStart"), p(0 <= b && b < g.length, "targetStart out of bounds"), p(0 <= a && a < this.length, "sourceStart out of bounds"), p(0 <= f && f <= this.length, "sourceEnd out of bounds"), f > this.length && (f = this.length), g.length - b < f - a && (f = g.length - b + a), f -= a, 100 > f || !c._useTypedArrays)for (var l = 0; l < f; l++)g[l + b] = this[l + a]; else g._set(this.subarray(a, a + f), b)
            };
            c.prototype.slice =
                function (b, a) {
                    var g = this.length;
                    b = I(b, g, 0);
                    a = I(a, g, g);
                    if (c._useTypedArrays)return c._augment(this.subarray(b, a));
                    for (var g = a - b, f = new c(g, void 0, !0), l = 0; l < g; l++)f[l] = this[l + b];
                    return f
                };
            ...
            c.prototype.readUInt8 = function (b, a) {
                a || (p(void 0 !== b && null !==
                    b, "missing offset"), p(b < this.length, "Trying to read beyond buffer length"));
                if (!(b >= this.length))return this[b]
            };
            ...
            c.prototype.fill = function (b, a, f) {
                ...
                p(f >= a, "end < start");
                if (f !== a && 0 !== this.length)for (p(0 <= a && a < this.length, "start out of bounds"), p(0 <= f && f <= this.length,
                    "end out of bounds"); a < f; a++)this[a] = b
            };
            c.prototype.inspect = function () {
                for (var b = [], a = this.length, f = 0; f < a; f++)if (b[f] = C(this[f]), f === m.INSPECT_MAX_BYTES) {
                    b[f + 1] = "...";
                    break
                }
            ...
            c.prototype.toArrayBuffer = function () {
                if ("undefined" !== typeof Uint8Array) {
                    ...
                    for (var b = new Uint8Array(this.length), a = 0, f = b.length; a < f; a += 1)b[a] = this[a];
                    return b.buffer
                }
        ...
        5: [function (n, v, m) {
            m.read = function (c, d, k, q, e) {
                ...
                if (0 === k)k = 1 - u; else {
                    if (k === h)return a ? NaN : Infinity * (f ? -1 : 1);
                    a += Math.pow(2, q);
                    k -= u
                }
            ...
            m.write = function (c, d, k, q, e, a) {
                var h, u =
                    8 * a - e - 1, r = (1 << u) - 1, b = r >> 1, f = 23 === e ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
                a = q ? 0 : a - 1;
                var G = q ? 1 : -1, t = 0 > d || 0 === d && 0 > 1 / d ? 1 : 0;
                d = Math.abs(d);
        ...
        7: [function (n, v, m) {
            (function (c) {
                function d(a, c) {
                    ...
                    if (c)for (; e--; e)a.unshift("..");
                    return a
                }

                function k(a, c) {
                    if (a.filter)return a.filter(c);
                    for (var e = [], h = 0; h < a.length; h++)c(a[h], h, a) && e.push(a[h]);
                    return e
                }
                ...
                m.relative = function (a, c) {
                    ...
                    for (var h = e(a.split("/")), b = e(c.split("/")), f = Math.min(h.length, b.length), G = f, t = 0; t < f; t++)if (h[t] !== b[t]) {
                        G = t;
                        break
                    }
                    f = [];
                    for (t = G; t < h.length; t++)f.push("..");
                ...
                m.basename = function (a, c) {
                    ...
                    c && e.substr(-1 * c.length) ===
                    c && (e = e.substr(0, e.length - c.length));
                    return e
                };
            ...
            }).call(this, n("node_modules/insert-module-globals/node_modules/process/browser.js"))
        ...
        8: [function (n, v, m) {
            ...
            var d = n("./util"), k = Object.prototype.hasOwnProperty;
            c.fromArray = function (d, e) {
                for (var a = new c, h = 0, k = d.length; h < k; h++)a.add(d[h], e);
                return a
            };
            ...
            c.prototype.add = function (c, e) {
                var a = d.toSetString(c), h = k.call(this._set, a), u = this._array.length;
            ...
            c.prototype.indexOf = function (c) {
                ...
                if (k.call(this._set, e))return this._set[e];
                throw Error('"' +
                    c + '" is not in the set.');
            };
        ...
        9: [function (n, v, m) {
            var c = n("./base64");
            m.encode = function (d) {
                var k = "", q = 0 > d ? (-d << 1) + 1 : (d << 1) + 0;
                do d = q & 31, q >>>= 5, 0 < q && (d |= 32), k += c.encode(d); while (0 < q);
                return k
            };
            m.decode = function (d, k, q) {
                var e = d.length, a = 0, h = 0;
                do {
                    if (k >= e)throw Error("Expected more digits in base 64 VLQ value.");
                    var u = c.decode(d.charCodeAt(k++));
                    if (-1 === u)throw Error("Invalid base64 digit: " + d.charAt(k - 1));
                    var r = !!(u & 32);
                    u &= 31;
                    a += u << h;
                    h += 5
        ...
        10: [function (n, v, m) {
            ...
            m.encode = function (d) {
                if (0 <= d && d < c.length)return c[d];
                throw new TypeError("Must be between 0 and 63: " + d);
            };
            m.decode = function (c) {
                return 65 <= c && 90 >= c ? c - 65 : 97 <= c && 122 >= c ? c - 97 + 26 : 48 <= c && 57 >= c ? c - 48 + 52 : 43 == c ?
                    62 : 47 == c ? 63 : -1
            }
        }, {}],
        11: [function (n, v, m) {
            function c(d, k, q, e, a, h) {
                var u = Math.floor((k - d) / 2) + d, r = a(q, e[u], !0);
        ...
        12: [function (n, v, m) {
            ...
            c.prototype.add = function (c) {
                var k = this._last, e = k.generatedLine, a = c.generatedLine, h = k.generatedColumn, u = c.generatedColumn;
        ...
        13: [function (n, v, m) {
            ...
            function d(k, m, e, a) {
                if (e < a) {
                    ...
                    for (var u = k[a], r = e; r < a; r++)0 >= m(k[r], u) && (h += 1, c(k, h, r));
                    c(k, h + 1, r);
                    h += 1;
                    d(k, m, e, h - 1);
                    d(k, m, h + 1, a)
        ...
        14: [function (n, v, m) {
            ...
            function d(b) {
                ...
                var c = e.getArg(a, "sources"), t = e.getArg(a, "names", []), d = e.getArg(a, "sourceRoot", null), r = e.getArg(a, "sourcesContent", null), k = e.getArg(a, "mappings"), a = e.getArg(a, "file", null);
            ...
            function q(b) {
                ...
                this._sources = new h;
                this._names = new h;
                var d = {line: -1, column: 0};
                this._sections = a.map(function (b) {
                    if (b.url)throw Error("Support for url field in sections not implemented.");
                    var a = e.getArg(b, "offset"), f = e.getArg(a, "line"), t = e.getArg(a, "column");
                    if (f < d.line || f === d.line && t < d.column)throw Error("Section offsets must be ordered and non-overlapping.");
                    d = a;
                    return {
                        generatedOffset: {generatedLine: f + 1, generatedColumn: t + 1},
                        consumer: new c(e.getArg(b, "map"))
                    }
                })
            }

            var e = n("./util"), a = n("./binary-search"), h = n("./array-set").ArraySet, u = n("./base64-vlq"), r = n("./quick-sort").quickSort;
            c.fromSourceMap = function (b) {
                return d.fromSourceMap(b)
            };
            c.prototype._version = 3;
            c.prototype.__generatedMappings =
                null;
            ...
            c.prototype.allGeneratedPositionsFor = function (b) {
                ...
                d.source =
                    this._sources.indexOf(d.source);
                var t = [], d = this._findMapping(d, this._originalMappings, "originalLine", "originalColumn", e.compareByOriginalPositions, a.LEAST_UPPER_BOUND);
                if (0 <= d) {
                    var h = this._originalMappings[d];
                    if (void 0 === b.column)for (c = h.originalLine; h && h.originalLine === c;)t.push({
                        line: e.getArg(h, "generatedLine", null),
                        column: e.getArg(h, "generatedColumn", null),
                        lastColumn: e.getArg(h, "lastGeneratedColumn", null)
                    }), h = this._originalMappings[++d]; else for (b = h.originalColumn; h && h.originalLine === c && h.originalColumn ==
                    b;)t.push({
                        line: e.getArg(h, "generatedLine", null),
                        column: e.getArg(h, "generatedColumn", null),
                        lastColumn: e.getArg(h, "lastGeneratedColumn", null)
            ...
            d.fromSourceMap = function (b) {
                var a = Object.create(d.prototype), c = a._names = h.fromArray(b._names.toArray(), !0), t = a._sources = h.fromArray(b._sources.toArray(), !0);
                a.sourceRoot = b._sourceRoot;
                a.sourcesContent = b._generateSourcesContent(a._sources.toArray(),
                    a.sourceRoot);
                a.file = b._file;
            ...
            d.prototype._parseMappings = function (b, a) {
                for (var c = 1, f = 0, d = 0, h = 0, m = 0, q = 0, n = b.length, y = 0, v = {}, A = {}, F = [], H = [], z, E, p, D, J; y < n;)if (";" === b.charAt(y))c++, y++, f = 0; else if ("," === b.charAt(y))y++; else {
                    z = new k;
                    z.generatedLine = c;
                    for (D = y; D < n && !this._charIsMappingSeparator(b, D); D++);
                    E = b.slice(y, D);
                    if (p = v[E])y += E.length; else {
                        for (p = []; y < D;)u.decode(b, y, A), J = A.value, y = A.rest,
                            p.push(J);
            ...
            d.prototype._findMapping = function (b, c, e, d, h, r) {
                if (0 >= b[e])throw new TypeError("Line must be greater than or equal to 1, got " + b[e]);
                if (0 > b[d])throw new TypeError("Column must be greater than or equal to 0, got " + b[d]);
            ...
            d.prototype.originalPositionFor = function (b) {
                var a = {generatedLine: e.getArg(b, "line"), generatedColumn: e.getArg(b, "column")};
                ...
                if (0 <= b && (b = this._generatedMappings[b], b.generatedLine === a.generatedLine)) {
                    ...
                    null !== a && (a =
                        this._sources.at(a), null != this.sourceRoot && (a = e.join(this.sourceRoot, a)));
            ...
            d.prototype.sourceContentFor =
                function (b, a) {
                    ...
                    if (null != this.sourceRoot && (c = e.urlParse(this.sourceRoot))) {
                        ...
                        if ("file" == c.scheme && this._sources.has(f))return this.sourcesContent[this._sources.indexOf(f)];
            ...
            d.prototype.generatedPositionFor = function (b) {
                ...
                if (!this._sources.has(a))return {line: null, column: null, lastColumn: null};
                a = this._sources.indexOf(a);
                a = {source: a, originalLine: e.getArg(b, "line"), originalColumn: e.getArg(b, "column")};
            ...
            Object.defineProperty(q.prototype, "sources", {
                get: function () {
                    for (var a = [], c = 0; c < this._sections.length; c++)for (var e = 0; e < this._sections[c].consumer.sources.length; e++)a.push(this._sections[c].consumer.sources[e]);
                    return a
                }
            });
            q.prototype.originalPositionFor = function (b) {
                ...
                return (d = this._sections[d]) ? d.consumer.originalPositionFor({
                    ...
                    column: c.generatedColumn - (d.generatedOffset.generatedLine === c.generatedLine ? d.generatedOffset.generatedColumn -
                    1 : 0),
                    bias: b.bias
            ...
            q.prototype._parseMappings = function (a, c) {
                ...
                for (var b = 0; b < this._sections.length; b++)for (var f = this._sections[b], d = f.consumer._generatedMappings,
                                                                        h = 0; h < d.length; h++) {
                    var k = d[h], u = f.consumer._sources.at(k.source);
                    null !== f.consumer.sourceRoot && (u = e.join(f.consumer.sourceRoot, u));
                    this._sources.add(u);
                    var u = this._sources.indexOf(u), m = f.consumer._names.at(k.name);
                    this._names.add(m);
        ...
        15: [function (n, v, m) {
            function c(a) {
                ...
                this._skipValidation = k.getArg(a,
                    "skipValidation", !1);
                this._sources = new q;
                this._names = new q;
            ...
            var d = n("./base64-vlq"), k = n("./util"), q = n("./array-set").ArraySet, e = n("./mapping-list").MappingList;
            c.prototype._version = 3;
            c.fromSourceMap = function (a) {
                var e = a.sourceRoot, d = new c({file: a.file, sourceRoot: e});
            ...
            c.prototype.addMapping = function (a) {
                var c = k.getArg(a, "generated"), e = k.getArg(a, "original", null), d = k.getArg(a, "source", null);
            ...
            c.prototype.setSourceContent = function (a, c) {
                ...
                null != c ? (this._sourcesContents || (this._sourcesContents = Object.create(null)), this._sourcesContents[k.toSetString(e)] = c) : this._sourcesContents && (delete this._sourcesContents[k.toSetString(e)], 0 === Object.keys(this._sourcesContents).length && (this._sourcesContents =
                    null))
            };
            c.prototype.applySourceMap = function (a, c, e) {
                ...
                this._mappings.unsortedForEach(function (c) {
                    if (c.source === d && null != c.originalLine) {
                        var t = a.originalPositionFor({line: c.originalLine, column: c.originalColumn});
                        null != t.source && (c.source =
                            t.source, null != e && (c.source = k.join(e, c.source)), null != b && (c.source = k.relative(b, c.source)), c.originalLine = t.line, c.originalColumn = t.column, null != t.name && (c.name = t.name))
                    }
                    t = c.source;
            ...
            c.prototype._validateMapping = function (a, c, e, d) {
                if (!(a && "line" in
                    a && "column" in a && 0 < a.line && 0 <= a.column && !c && !e && !d || a && "line" in a && "column" in a && c && "line" in c && "column" in c && 0 < a.line && 0 <= a.column && 0 < c.line && 0 <= c.column && e))throw Error("Invalid mapping: " + JSON.stringify({
                        generated: a,
                        source: e,
                        original: c,
                        name: d
            ...
            c.prototype._serializeMappings = function () {
                for (var a = 0, c = 1, e = 0, m = 0, b = 0, f = 0, q = "", t, n, I, B = this._mappings.toArray(), v = 0, C = B.length; v < C; v++) {
                    n = B[v];
                    t = "";
                    if (n.generatedLine !== c)for (a = 0; n.generatedLine !== c;)t += ";", c++; else if (0 < v) {
                        if (!k.compareByGeneratedPositionsInflated(n,
                                B[v - 1]))continue;
                        t += ","
                    }
            ...
            "./array-set": 8,
            "./base64-vlq": 9, "./mapping-list": 12, "./util": 17
        }],
        16: [function (n, v, m) {
            ...
            var d = n("./source-map-generator").SourceMapGenerator, k = n("./util"), q = /(\r?\n)/;
            c.fromStringWithSourceMap = function (e, a, d) {
                ...
                var m = new c, b = e.split(q), f = function () {
                ...
                a.eachMapping(function (a) {
                    ...
                    for (; n < a.generatedLine;)m.add(f()), n++;
            ...
            c.prototype.add = function (c) {
                if (Array.isArray(c))c.forEach(function (a) {
                    this.add(a)
                }, this); else if (c.$$$isSourceNode$$$ || "string" === typeof c)c && this.children.push(c); else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + c);
                return this
            };
            c.prototype.prepend = function (c) {
                if (Array.isArray(c))for (var a =
                    c.length - 1; 0 <= a; a--)this.prepend(c[a]); else if (c.$$$isSourceNode$$$ || "string" === typeof c)this.children.unshift(c); else throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + c);
                return this
            };
            c.prototype.walk = function (c) {
                for (var a, e = 0, d = this.children.length; e < d; e++)a = this.children[e], a.$$$isSourceNode$$$ ? a.walk(c) : "" !== a && c(a, {
                    source: this.source,
                    line: this.line,
                    column: this.column,
                    name: this.name
            ...
            c.prototype.join = function (c) {
                var a, e = this.children.length;
                if (0 <
                    e) {
                    var d = [];
                    for (a = 0; a < e - 1; a++)d.push(this.children[a]), d.push(c);
            ...
            c.prototype.walkSourceContents = function (c) {
                for (var a =
                    0, e = this.children.length; a < e; a++)this.children[a].$$$isSourceNode$$$ && this.children[a].walkSourceContents(c);
                for (var d = Object.keys(this.sourceContents), a = 0, e = d.length; a < e; a++)c(k.fromSetString(d[a]), this.sourceContents[d[a]])
            };
            c.prototype.toString = function () {
                var c = "";
            ...
            c.prototype.toStringWithSourceMap = function (c) {
                var a = "", e = 1, k = 0, m = new d(c), b = !1, f = null, n = null, t = null, q = null;
                this.walk(function (c, d) {
                    a += c;
                    null !== d.source && null !== d.line && null !== d.column ? (f === d.source &&
                    n === d.line && t === d.column && q === d.name || m.addMapping({
                        source: d.source,
                        original: {line: d.line, column: d.column},
                        generated: {line: e, column: k},
                        name: d.name
                    }), f = d.source, n = d.line, t = d.column, q = d.name, b = !0) : b && (m.addMapping({
                        generated: {
                            line: e,
                            column: k
                        }
                    }), f = null, b = !1);
                    for (var h = 0, r = c.length; h < r; h++)10 === c.charCodeAt(h) ? (e++, k = 0, h + 1 === r ? (f = null, b = !1) : b && m.addMapping({
                        source: d.source,
                        original: {line: d.line, column: d.column},
                        generated: {line: e, column: k},
                        name: d.name
        ...
        17: [function (n, v, m) {
            ...
            function k(a) {
                ...
                a = m.isAbsolute(b);
                for (var b = b.split(/\/+/), k, h = 0, n = b.length - 1; 0 <= n; n--)k = b[n], "." ===
                k ? b.splice(n, 1) : ".." === k ? h++ : 0 < h && ("" === k ? (b.splice(n + 1, h), h = 0) : (b.splice(n, 2), h--));
                b = b.join("/");
                "" === b && (b = a ? "/" : ".");
            ...
            function h(a) {
                if (!a)return !1;
                var b = a.length;
                if (9 > b || 95 !== a.charCodeAt(b - 1) || 95 !== a.charCodeAt(b - 2) || 111 !== a.charCodeAt(b - 3) || 116 !== a.charCodeAt(b - 4) || 111 !== a.charCodeAt(b - 5) || 114 !== a.charCodeAt(b - 6) || 112 !== a.charCodeAt(b - 7) || 95 !== a.charCodeAt(b - 8) || 95 !== a.charCodeAt(b -
                        9))return !1;
            ...
            m.join = function (a, e) {
                ...
                var b = c(e), f = c(a);
                f && (a = f.path || "/");
                if (b && !b.scheme)return f && (b.scheme = f.scheme), d(b);
                if (b || e.match(r))return e;
                if (f && !f.host && !f.path)return f.host = e, d(f);
            ...
            m.compareByGeneratedPositionsInflated = function (a, c) {
                ...
                b = a.generatedColumn - c.generatedColumn;
                if (0 !== b)return b;
                var b = a.source, d = c.source, b = b === d ? 0 : b > d ? 1 : -1;
                if (0 !== b)return b;
                b = a.originalLine - c.originalLine;
                if (0 !== b)return b;
                b = a.originalColumn - c.originalColumn;
        ...
        }, {"./lib/source-map-consumer": 14, "./lib/source-map-generator": 15, "./lib/source-node": 16}],
        19: [function (n, v, m) {
            (function (c, d) {
                function k() {
                    return "browser" === K ? !0 : "node" === K ? !1 : "undefined" !== typeof window && "function" === typeof XMLHttpRequest && !(window.require && window.module && window.process &&
                ...
                function e(a, b) {
                    if (!a)return b;
                    var c = I.dirname(a), d = /^\w+:\/\/[^\/]*/.exec(c), d = d ? d[0] : "";
                ...
                function u() {
                    ...
                    if (this.isNative())a = "native"; else {
                        ...
                        !b && this.isEval() && (a = this.getEvalOrigin(),
                            a += ", ");
                        a = b ? a + b : a + "<anonymous>";
                    ...
                    b = "";
                    var c = this.getFunctionName(), d = !0, e = this.isConstructor();
                ...
                function b(b) {
                    ...
                    if (c) {
                        var d = b.getLineNumber(), e = b.getColumnNumber() - 1;
                        1 !== d || k() || b.isEval() || (e -= 62);
                        var f = a({source: c, line: d, column: e});
                        b = r(b);
                ...
                function v(a) {
                    ...
                    if (b) {
                        a = b[1];
                        var c = +b[2], b = +b[3], d = A[a];
                        !d && B && B.existsSync(a) && (d = B.readFileSync(a, "utf8"));
                        if (d && (d = d.split(/(?:\r\n|\r|\n)/)[c - 1]))return a + ":" + c + "\n" + d + "\n" + Array(b).join(" ") +
                            "^"
                    }
                    return null
                ...
                function t() {
                    ...
                    c.emit = function (b) {
                        if ("uncaughtException" === b) {
                            var d = arguments[1] && arguments[1].stack, e = 0 < this.listeners(b).length;
                            if (d && !e) {
                                d = arguments[1];
                                if (e = v(d))console.error(), console.error(e);
                ...
                var M = n("source-map").SourceMapConsumer, I = n("path");
                try {
                    var B = n("fs");
                    B.existsSync && B.readFileSync || (B = null)
                } catch (J) {
                }
                var L = !1, C = !1, y = !1, K = "auto", A = {}, F = {}, H = /^data:application\/json[^,]+base64,/, z = [], E =
                    [], p = q(z);
                z.push(function (a) {
                    a = a.trim();
                    if (a in A)return A[a];
                    var b = null;
                    if (B)B.existsSync(a) && (b = B.readFileSync(a, "utf8")); else {
                ...
                m.install = function (a) {
                    a = a || {};
                    if (a.environment && (K = a.environment, -1 === ["node", "browser", "auto"].indexOf(K)))throw Error("environment " + K + " was unknown. Available options are {auto, browser, node}");
                    a.retrieveFile && (a.overrideRetrieveFile && (z.length =
                        0), z.unshift(a.retrieveFile));
                    ...
                    !C && ("handleUncaughtExceptions" in a ?
                        a.handleUncaughtExceptions : 1) && "object" === typeof c && null !== c && "function" === typeof c.on && (C = !0, t())
                }
            }).call(this, n("node_modules/insert-module-globals/node_modules/process/browser.js"), n("buffer").Buffer)
        }, {
            "node_modules/insert-module-globals/node_modules/process/browser.js": 6,
            buffer: 4,
            fs: 3,
