...
var BooleanLiteral = function (_Expression) {
    (0, _inherits3.default)(BooleanLiteral, _Expression);

    function BooleanLiteral(childNodes) {
    ...
    (0, _createClass3.default)(BooleanLiteral, [{
        key: '_acceptChildren',
