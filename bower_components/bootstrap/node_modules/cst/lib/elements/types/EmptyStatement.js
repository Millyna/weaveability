...
var EmptyStatement = function (_Statement) {
    (0, _inherits3.default)(EmptyStatement, _Statement);

    function EmptyStatement(childNodes) {
    ...
    (0, _createClass3.default)(EmptyStatement, [{
        key: '_acceptChildren',
