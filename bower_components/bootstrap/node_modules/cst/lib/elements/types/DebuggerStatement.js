...
var DebuggerStatement = function (_Statement) {
    (0, _inherits3.default)(DebuggerStatement, _Statement);

    function DebuggerStatement(childNodes) {
    ...
    (0, _createClass3.default)(DebuggerStatement, [{
        key: '_acceptChildren',
