...
var TaggedTemplateExpression = function (_Expression) {
    (0, _inherits3.default)(TaggedTemplateExpression, _Expression);

    function TaggedTemplateExpression(childNodes) {
    ...
    (0, _createClass3.default)(TaggedTemplateExpression, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            var tag = children.passExpression();
            children.skipNonCode();
            var quasi = children.passNode('TemplateLiteral');
