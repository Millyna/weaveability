...
var ClassExpression = function (_Expression) {
    (0, _inherits3.default)(ClassExpression, _Expression);

    function ClassExpression(childNodes) {
    ...
    (0, _createClass3.default)(ClassExpression, [{
        key: '_acceptChildren',
