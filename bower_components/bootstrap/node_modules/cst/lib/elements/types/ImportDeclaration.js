...
var ImportDeclaration = function (_ModuleDeclaration) {
    (0, _inherits3.default)(ImportDeclaration, _ModuleDeclaration);

    function ImportDeclaration(childNodes) {
    ...
    (0, _createClass3.default)(ImportDeclaration, [{
        key: '_acceptChildren',
