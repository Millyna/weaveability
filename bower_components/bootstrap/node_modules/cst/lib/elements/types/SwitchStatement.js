...
var SwitchStatement = function (_Statement) {
    (0, _inherits3.default)(SwitchStatement, _Statement);

    function SwitchStatement(childNodes) {
    ...
    (0, _createClass3.default)(SwitchStatement, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            ...
            var discriminant = children.passExpression();
            children.skipNonCode();
