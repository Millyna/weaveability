...
var ThisExpression = function (_Expression) {
    (0, _inherits3.default)(ThisExpression, _Expression);

    function ThisExpression(childNodes) {
    ...
    (0, _createClass3.default)(ThisExpression, [{
        key: '_acceptChildren',
