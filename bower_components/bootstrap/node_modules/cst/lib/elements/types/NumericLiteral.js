...
var NumericLiteral = function (_Expression) {
    (0, _inherits3.default)(NumericLiteral, _Expression);

    function NumericLiteral(childNodes) {
    ...
    (0, _createClass3.default)(NumericLiteral, [{
        key: '_acceptChildren',
