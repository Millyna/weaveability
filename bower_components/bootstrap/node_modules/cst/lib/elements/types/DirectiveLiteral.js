...
var DirectiveLiteral = function (_Expression) {
    (0, _inherits3.default)(DirectiveLiteral, _Expression);

    function DirectiveLiteral(childNodes) {
    ...
    (0, _createClass3.default)(DirectiveLiteral, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            children.assertToken();
            var value = children.currentElement.value;
            var rawValue = children.currentElement.getSourceCode();
...
exports.default = DirectiveLiteral;
