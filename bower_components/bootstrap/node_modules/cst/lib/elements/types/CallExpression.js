...
var CallExpression = function (_Expression) {
    (0, _inherits3.default)(CallExpression, _Expression);

    function CallExpression(childNodes) {
    ...
    (0, _createClass3.default)(CallExpression, [{
        key: '_acceptChildren',
