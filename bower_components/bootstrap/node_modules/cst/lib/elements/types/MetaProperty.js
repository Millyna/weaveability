...
var MetaProperty = function (_Expression) {
    (0, _inherits3.default)(MetaProperty, _Expression);

    function MetaProperty(childNodes) {
    ...
    (0, _createClass3.default)(MetaProperty, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            var meta = children.passNode('Identifier');
            children.skipNonCode();
            children.passToken('Punctuator', '.');
            children.skipNonCode();
            var property = children.passNode('Identifier');
            children.assertEnd();
