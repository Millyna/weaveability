...
var BinaryExpression = function (_Expression) {
    (0, _inherits3.default)(BinaryExpression, _Expression);

    // TODO: Should respect operator precedence: putting "a + b" before " * b" without parens should raise an error.

    function BinaryExpression(childNodes) {
    ...
    (0, _createClass3.default)(BinaryExpression, [{
        key: '_acceptChildren',
