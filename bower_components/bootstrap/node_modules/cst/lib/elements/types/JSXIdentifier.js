...
var JSXIdentifier = function (_Expression) {
    (0, _inherits3.default)(JSXIdentifier, _Expression);

    function JSXIdentifier(childNodes) {
        (0, _classCallCheck3.default)(this, JSXIdentifier);
    ...
    (0, _createClass3.default)(JSXIdentifier, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            var name = children.passToken('JSXIdentifier').value;
            children.assertEnd();
...
exports.default = JSXIdentifier;
//# sourceMappingURL=JSXIdentifier.js.map