...
var JSXNamespacedName = function (_Expression) {
    (0, _inherits3.default)(JSXNamespacedName, _Expression);

    function JSXNamespacedName(childNodes) {
    ...
    (0, _createClass3.default)(JSXNamespacedName, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            var namespace = children.passNode('JSXIdentifier');
            children.skipNonCode();
            children.passToken('Punctuator', ':');
            children.skipNonCode();
            var name = children.passNode('JSXIdentifier');
            children.assertEnd();
...
exports.default = JSXNamespacedName;
//# sourceMappingURL=JSXNamespacedName.js.map